...
* **_git log_** - команда позволяет посмотреть все коммиты в данной ветке коммитов. белеберда
    ...
    - *git log --graph* - показывает все коммиты с графическим изображением веток. белеберда
* **_git checkout_** - команда позволяет переключатся между коммитами. белеберда
    ...
    - *git checkout master* - переход на актуальную версию файла в данной ветке. белеберда
...
* **_git branch -d_ name_branch** - удаление ветки с именем name_branch, производить только после того как сохранили все изменения
